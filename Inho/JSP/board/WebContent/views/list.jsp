				...
				<div class="list-group">
					...
					<div class="input-group">
						...
						<span class="input-group-btn">
							<button class="btn btn-default" onclick="searchArticle()">검색</button>
						</span> 
					</div>

					<button class="btn btn-defalut" onclick="location.href='/write.do'">글쓰기</button>
					<button class="btn btn-defalut" onclick="location.href='/'">뒤로가기</button>
